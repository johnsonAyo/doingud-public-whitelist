      ...
      if (joinedWhitelist) {
        return (
          <div className={styles.description}>
            Thanks for joining the doingud Whitelist!
          </div>
        );
      } else if (loading) {
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        ...
        <div>
          <img className={styles.image} src="./doingud.jpeg" />
        </div>
      </div>

      <footer className={styles.footer}>Made with &#10084; by Johnson</footer>
    </div>
  );
}
